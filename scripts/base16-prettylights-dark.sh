...
color17="c9/d1/d9" # Base 0F
color18="16/1b/22" # Base 01
color19="37/46/5D" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 37465D # selection color
